                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="fingerid" placeholder="User Fingerprint ID" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check form-check-warning">
                            <label class="form-check-label">
                                <input type="radio" class="form-check" name="gender" value="Male" required>
                                Laki-Laki
                            </label>
                        </div>
                        <div class="form-check form-check-warning">
                            <label class="form-check-label">
                                <input type="radio" class="form-check" name="gender" value="Female" required>
                                Perempuan
                            </label>
                        </div>
                    </div>
